...
const CustomerDetail = () => {
  ...
  const actions: ActionType[] = [
    ...
    {
      label: "Supprimer (pas encore disponible)",
  ...
  return (
    <div>
      <Breadcrumb
        currentPage={"Détails du client"}
        previousBreadcrumb={"Clients"}
          ...
          <div className="h-100 flex flex-col pl-6">
            ...
            <div className="h-50 flex items-center justify-center">
              <StatusDot
                ...
                title={customer?.has_account ? "Oui" : "Non"}
              />
            </div>
          </div>
        </div>
      ...
      <BodyCard
        title={`Commandes (${customer?.orders.length})`}
        subtitle="Vue d'ensemble des commandes du client"
      >
        {isLoading || !customer ? (
      ...
      <div className="mt-large">
        <RawJSON data={customer} title="Données" rootName="customer" />
      </div>
